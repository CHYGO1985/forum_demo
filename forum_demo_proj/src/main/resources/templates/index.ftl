                    ...
                    <div id="js-home-feed-list" class="zh-general-list topstory clearfix" data-init="{&quot;params&quot;: {}, &quot;nodename&quot;: &quot;TopStory2FeedList&quot;}" data-delayed="true" data-za-module="TopStoryFeedList">
                        ...
                        " feed-item-a="" data-type="a" id="feed-2" data-za-module="FeedItem" data-za-index="">
                            ...
                            <div class="feed-item-inner">
                                <div class="avatar">
                                    <a title="${(viewObj.user.name) !}" data-tip="p$t$amuro1230" class="zm-item-link-avatar" target="_blank" href="https://nowcoder.com/people/amuro1230">
                                ...
                                <div class="feed-main">
                                    <div class="feed-content" data-za-module="AnswerItem">
                                        ...
                                        <h2 class="feed-title">
                                            <a class="question_link" target="_blank" href="/question/${(viewObj.question.id) !}">${(viewObj.question.title) ! "Default Name"}</a></h2>
                                        ...
                                        <div class="expandable entry-body">
                                            ...
                                            <div class="zm-item-answer-author-info">
                                                <a class="author-link" data-tip="p$b$amuro1230" target="_blank" href="/user/${(viewObj.user.id) !}">${(viewObj.user.name) ! "Default User"}</a>
                                            ...
                                            <div class="zm-item-rich-text expandable js-collapse-body" data-resourceid="123114" data-action="/answer/content" data-author-name="JJ" data-entry-url="/question/19857995/answer/13174385">
                                                <div class="zh-summary summary clearfix">${(viewObj.question.content) ! "Defaule Content"}</div>
                                            </div>
                                        </div>
                                        <div class="feed-meta">
